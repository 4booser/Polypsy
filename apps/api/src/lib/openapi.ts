...
export const ROUTE_DOCS: Record<string, RouteDoc> = {
  ...
  "POST /api/stat-models/run": { summary: "«Порівняти» без сохранения; малые ячейки подавляются дополняюще", access: "staff", permission: "statistics.read", body: statModelRunSchema },
  ...
  "POST /api/stat-models/:id/run": { summary: "«Оновити»: расчёт по сохранённой модели; малые ячейки подавляются дополняюще", access: "staff", permission: "statistics.read" },
