...
export const ROUTE_DOCS: Record<string, RouteDoc> = {
  ...
  "POST /api/kiosk/sessions": { summary: "Создание сеанса киоска", access: "staff", permission: "kiosk.manage", body: createKioskSessionSchema },
  "GET /api/kiosk/sessions": { summary: "Сеансы киоска и живой прогресс", access: "staff", permission: "kiosk.manage" },
  "POST /api/kiosk/sessions/:id/close": { summary: "Закрытие сеанса", access: "staff", permission: "kiosk.manage" },
  ...
  "POST /api/informants/patients/:userId": { summary: "Выдать ссылку человеку со стороны (командир, близкий, врач)", access: "staff", permission: "informants.manage" },
  "GET /api/informants/patients/:userId": { summary: "Запросы к информантам по пациенту", access: "staff", permission: "informants.manage" },
  "POST /api/informants/:id/revoke": { summary: "Отозвать ссылку информанта", access: "staff", permission: "informants.manage" },
  ...
  "POST /api/conferences/:id/decide": { summary: "Зафиксировать решение консилиума", access: "staff", permission: "conferences.manage" },
  ...
  "GET /api/goals/patients/:userId": { summary: "Цели лечения пациента с прогрессом", access: "staff", permission: "goals.manage" },
  "POST /api/goals/patients/:userId": { summary: "Поставить измеримую цель", access: "staff", permission: "goals.manage" },
  "PATCH /api/goals/:id": { summary: "Закрыть цель с исходом", access: "staff", permission: "goals.manage" },
  ...
  "GET /api/pathways": { summary: "Шаблоны маршрутов помощи", access: "staff", permission: "pathways.manage" },
  "POST /api/pathways": { summary: "Завести шаблон маршрута", access: "staff", permission: "pathways.manage" },
  "POST /api/pathways/:id/start": { summary: "Поставить пациента на маршрут", access: "staff", permission: "pathways.manage" },
  "GET /api/pathways/instances": { summary: "Кто на маршрутах: просроченные сверху", access: "staff", permission: "pathways.manage" },
  ...
  "GET /api/templates": { summary: "Шаблоны заключений и заметок, справочник формулировок", access: "staff", permission: "patients.read" },
