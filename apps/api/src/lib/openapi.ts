...
export const ROUTE_DOCS: Record<string, RouteDoc> = {
  ...
  "POST /api/informants/:id/revoke": { summary: "Отозвать ссылку информанта", access: "staff" },
  ...
  "GET /api/conferences/patients/:userId": { summary: "Консилиумы по пациенту с мнениями", access: "staff" },
  "POST /api/conferences/patients/:userId": { summary: "Вынести случай на консилиум", access: "staff" },
  "POST /api/conferences/:id/opinions": { summary: "Высказать мнение или особое мнение", access: "staff" },
  "POST /api/conferences/:id/decide": { summary: "Зафиксировать решение консилиума", access: "staff" },
  ...
  "GET /api/safety/patients/:userId": { summary: "План безопасности пациента по версиям", access: "staff" },
  "PUT /api/safety/patients/:userId": { summary: "Сохранить план безопасности новой версией", access: "staff" },
  "GET /api/notes/patients/:userId": { summary: "Заметки приёма по пациенту", access: "staff" },
  "PUT /api/notes/patients/:userId": { summary: "Сохранить заметку приёма", access: "staff" },
  "POST /api/notes/patients/:userId/sign": { summary: "Подписать заметку приёма", access: "staff" },
