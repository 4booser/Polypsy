 ...
 *
 * Экспортируется ради одной проверки: техпанель держит свой, более широкий
 * список для буфера логов (lib/opsBuffer.ts), и тест следит, чтобы он
 * оставался надмножеством этого — поле, запрещённое к отправке в сборщик
 * ошибок, не должно всплывать на экране разработчика.
 */
export const FORBIDDEN = ["body", "headers", "cookies", "email", "firstName", "lastName", "birthDate", "answers"];
