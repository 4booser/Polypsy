...
import { informantRoutes } from "./routes/informants";
...
app.route("/api/informants", informantRoutes);
app.route("/api/devices", deviceRoutes);
app.route("/api/cohorts", cohortRoutes);
app.route("/api/break-glass", breakGlassRoutes);
...
app.route("/api/conferences", conferenceRoutes);
