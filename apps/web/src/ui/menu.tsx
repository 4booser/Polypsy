 ...
 *    плашка 142 с рамкой #999999 и тенью, пункты 15/400 серым прижаты к
...
export function menuItemClass(align: MenuAlign = "left", tone: MenuTone = "normal"): string {
  return cx(
     ...
     * трёх пунктов на 212, 242 и 272). Было 16 и 32.
     */
    align === "right"
...
function plateClass(align: MenuAlign): string {
  return cx(
    ...
    align === "right"
       ...
       * y 200…293; те же 142×94 на f30, f31, f40, f43, f50 (на f04 высота
       * 97 — единственный кадр из семи). Прежние «146×97» были сняты вместе
       * с тенью (1261…1408, 200…299) и давали плашку на 14px выше кадра:
       * py-[8px] сверху и снизу поверх трёх пунктов по 30.
       *
       * 94 = 2 рамки + 1 + три пункта по 30 + 1, отсюда py-[1px]. Чернила
       * пунктов на кадре стоят на 212, 242, 272 при плашке с 200 — шаг 30
       * сходится, верхнее поле выходит на два пикселя меньше кадрового.
       * Зазор от глифа 8 (на кадре 9) оставлен.
       */
      ? "top-[calc(100%+8px)] min-w-[142px] rounded-[5px] border border-border-strong bg-[var(--bg)] py-[1px] shadow-pop"
