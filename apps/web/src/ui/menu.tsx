...
/**
 * Шестерёнка 27×27 — замер кадра, залитая; та же, что в заключении
 * (Conclusion.tsx). Общий набор ui/index.tsx рисует контурные значки 24×24
 * штрихом 1.8 — в ряд с ними она не встаёт.
 */
...
/** «+» — штрих 5 в квадрате 27, как на кадрах над списками (тот же, что в каталоге) */
