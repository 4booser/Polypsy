 ...
 * строке. Линия — 2px цветом --primary-dim: на кадре она #b299cc, тот же
 * фиолетовый вполсилы, что у неактивной вкладки, и тем же токеном её рисует
 * карточка группы (PatientGroupCard). Заголовок — <h2>: <h1> занят словом
 * «Пацієнт». Строка заголовка не ниже 27 — высоты глифа — и в разделе без
 * глифа («Групи») стоит на той же высоте, что и с ним: так на кадре.
 */
 ...
 * Цвет — ступень поверхности, как у строк списков людей (StaffList).
 */
