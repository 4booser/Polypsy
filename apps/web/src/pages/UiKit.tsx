...
const SWATCHES: [string, string][] = [
  ...
  ["--primary", "сине-фиолетовый: действие и состояние"],
  ["--sev-none", "норма"],
  ["--sev-mild", "лёгкая"],
 ...
 * протанопии, дейтеранопии и тританопии (худшая — 8,2 при пороге 8), при
...
export default function UiKit() {
  ...
  return (
    ...
    >
      <Stack>
      <Panel title="Палитра" hint="Янтарь занят смыслом и на кнопки не идёт. Сине-фиолетовый — действие и состояние: выбранная строка, включённый фильтр, активная вкладка.">
        <Grid min={230}>
        ...
        <div className="mt-5 border-t border-hairline pt-4">
          ...
          <p className="m-0 mt-2 max-w-[68ch] text-caption text-muted">
            Соседние пары различимы при трёх видах дальтонизма: худшая — 8,2 при пороге 8.
            Порог держится только для СОСЕДНИХ пар, и это не оговорка, а устройство:
            третий ряд с шестым отличаются на 5,6, и вместе в одном графике их брать
            нельзя — порядок рядов зафиксирован ровно поэтому. Девятого ряда не бывает:
            он сворачивается в «прочие».
          </p>
        </div>
      </Panel>
