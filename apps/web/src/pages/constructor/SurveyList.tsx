 ...
 * сетке 24, а каретка на макете — залитый треугольник 9×5 (та же, что у
 * селекта). «+» штрихом 5 в квадрате 27 когда-то тоже жил здесь; теперь он
 * нужен и группам пациентов и лежит в ui/glyphs.tsx.
 */
function IconCaret() {
  return (
