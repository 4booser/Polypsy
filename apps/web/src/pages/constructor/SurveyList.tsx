...
/*
 * Кадр f11: cap «Р» подписи колонки 9 px → 13/700, тело абзаца 13/400 с шагом
 * строк 14. Цвет подписи на кадре — #666666, то есть тот же серый, что у даты
 * папки и у тела абзаца; --text-2 (#333333) стоял здесь на ступень темнее
 * назначенного макетом и без основания (про --muted вместо #666666 см.
 * tokens.css: там отступление объяснено контрастом).
 */
const cellLabel = "text-[13px] font-bold leading-[17px] text-muted";
 ...
 */
/* шаг строк кадра 82,5 = имя 2×22 + абзац 3×14 + 2×18 отступа */
const cell = "h-auto border-0 py-[18px] pl-0 align-top";
