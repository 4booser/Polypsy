...
/*
 * Блок страниц («елементів на сторінці · сторінка N з M ‹ ›») живёт в
 * ui/pager.tsx: тот же блок нарисован на вкладке «Групи» карточки лікаря, и
 * держать его в двух экранах значило бы держать два набора одних замеров.
 * Ступени и арифметика страниц по-прежнему здесь, в catalogue.ts.
 */
