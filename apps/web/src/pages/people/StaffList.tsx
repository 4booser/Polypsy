 ...
 * снизу.
 *
 * Подсветка наведения — ровно по колонке и ровно #f7f5fa: на f04 (636…1038)
 * и f30 (1048…1419) она совпадает с шириной колонки строки, свеса нет, углы
 * прямые, цвет (247,245,250). Прежде она красилась --surface-2 (#f0ecff,
 * заливка плашек) и свешивалась на 8px в каждую сторону. Ступень под неё
 * заведена давно — --primary-tint, и в её собственном пояснении названо это
 * самое #f7f5fa.
 *
 * Кадр f35 даёт у строки группы другой тон (#eeecf1) — один кадр против
 * двух; подсветка в разделе одна на все списки.
 */
