...
/*
 * Экран «Заключення» — кадры макета f36 и f37 (прежняя нумерация — f38 и
 * f39; номера обновлены при сверке разделов «Пацієнти» и «Групи»).
 *
 ...
 * прописной в середине фразы, тогда как соседняя пилюля набрана
 * «Відповідає умовам». Это опечатка кадра, а не приём макета (прописную во
 * втором слове макет ставит в НАЗВАНИЯХ — «Опис Групи», «Назва
 * Заключення», — а не в середине фразы), и словарь оставлен со строчной:
 * cn3.notMatched «Не відповідає умовам». Записано здесь, чтобы следующая
 * сверка не «чинила» словарь обратно по кадру.
 */
