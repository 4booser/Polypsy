            ...
            <NavLink
              ...
              className={cx(
                ...
                /*
                  ...
                  десяти кадров полосы бледный тон стоит на двух (f30 —
                  (179,152,206), f49 — (171,143,204)), а на восьми (f31,
                  f34, f35, f40, f41, f42, f43, f47, f48, f50) ровно
                  (102,51,153) при том же растре (217 тёмных пикселей и
                  там и там, то есть цвет, а не начертание). Кадры спорят
                  сами с собой на одном и том же экране списка: f42
                  рисует «Лікарі» полным цветом, f49 — «Адміністратори»
                  бледным.

                  Разрешено в пользу восьми, и второй довод тот же:
                  ...
                  одном кадре: на восьми подсветки нет вовсе, а на двух
                  она именно та, которую нельзя прочесть. «Вы здесь»
                  несёт aria-current, который NavLink ставит сам.
