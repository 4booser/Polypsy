            ...
            <NavLink
              ...
              className={cx(
                ...
                /*
                  ...
                  Прежняя редакция этого пояснения говорила обратное
                  («кадры рисуют полным цветом»), и её выборка — f30, f31,
                  f34, f35, f40…f43, f47…f50 — целиком из консолей людей и
                  админа, где пункт вообще один. Перемер доминирующего
                  цвета чернил КАЖДОГО пункта на всех кадрах полосы это
                  опровергает: бледный (171,143,204) стоит ровно на своём
                  пункте на f05 «Пацієнти», f06 «Групи», f07 «Тести», f08
                  «Статистика», f10 «Аналітика» и на всех трёх кадрах
                  этого раздела — f11, f20, f26 «Повідомлення». Восемь
                  кадров из сорока с полосой, шесть разделов из шести:
                  правило кадра есть, и оно наше.

                  Держит решение ровно один довод, зато он не спорный:
                  бледный кадра #ab8fcc на полосе #f0ecff даёт 2,41:1 —
                  втрое ниже нормы для 4.5:1 и ниже даже послабления для
                  крупного текста. Прочесть, где ты находишься, было бы
                  нельзя — а это единственное, ради чего подсветка и
                  нужна. Подставить «похожий, но читаемый» тон (#7a4ea6,
                  5,23:1 — тот самый, каким бледнит вкладки) можно, но это
                  уже не замер, а другое решение о всей консоли сразу, и
                  принимать его мимоходом в обходе одного раздела нельзя.
                  «Вы здесь» пока несёт aria-current, который NavLink
                  ставит сам, — диктор состояние получает.
