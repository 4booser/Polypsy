...
export const ERRORS = {
   ...
   */
  "err.surveyFolderNotFound": { uk: "Папку не знайдено", ru: "Папка не найдена" },
  ...
  "err.specialistNotFound": { uk: "Фахівця не знайдено", ru: "Специалист не найден" },
  "err.inviteExpired": {
   ...
   */
  "err.mailingNotFound": { uk: "Повідомлення не знайдено", ru: "Сообщение не найдено" },
  "err.mailingAlreadySent": {
    uk: "Повідомлення вже надіслано: текст і варіанти відповіді більше не змінюються",
    ru: "Сообщение уже отправлено: текст и варианты ответа больше не меняются",
  },
  "err.mailingSentNotDeletable": {
    uk: "Надіслане повідомлення не видаляється — його вже читали й відповідали. Його можна приховати",
    ru: "Отправленное сообщение не удаляется — его уже читали и отвечали. Его можно скрыть",
  },
  "err.mailingNoRecipients": {
    uk: "Немає жодного отримувача у вашій зоні відповідальності: надсилати нема кому",
  ...
  "err.exceptionAlreadyRevoked": { uk: "Виняток вже відкликано", ru: "Исключение уже отозвано" },
