...
export const ERRORS = {
  ...
  "err.batteryAccessDenied": { uk: "Немає доступу до набору", ru: "Нет доступа к набору" },
  "err.batteryArchived": { uk: "Набір в архіві", ru: "Набор в архиве" },
  "err.batteryNotFound": { uk: "Набір не знайдено", ru: "Набор не найден" },
  ...
  "err.batteryEmpty": { uk: "У наборі немає методик", ru: "В наборе нет методик" },
