...
export const ERRORS = {
  ...
  "err.googleTaken": {
    uk: "Цей обліковий запис Google уже прив’язано до іншого",
  ...
  "err.alreadyNamed": {
    uk: "Обліковий запис уже під іменем",
  ...
  "err.phoneExists": {
    uk: "Цей номер уже використовується",
    ru: "Этот номер уже используется",
  },
  "err.reportPeriodRequired": {
    uk: "Вкажіть період: дати у вигляді РРРР-ММ-ДД",
    ru: "Укажите период: даты в виде ГГГГ-ММ-ДД",
  },
  ...
  "err.episodeNotFound": { uk: "Звернення не знайдено", ru: "Обращение не найдено" },
  "err.episodeClosed": { uk: "Звернення вже закрито", ru: "Обращение уже закрыто" },
  ...
  "err.recordingConsentAlready": { uk: "Згоду вже отримано", ru: "Согласие уже получено" },
  ...
  "err.recordingAlready": { uk: "Прийом уже записано", ru: "Приём уже записан" },
  ...
  "err.threadNotFound": { uk: "Листування не знайдено", ru: "Переписка не найдена" },
  ...
  "err.templateNotFound": { uk: "Шаблон не знайдено", ru: "Шаблон не найден" },
  "err.templateForeignDepartment": {
    uk: "Шаблон заводять у своєму відділенні",
    ru: "Шаблон заводят в своём отделении",
  },
  ...
  "err.departmentNotFound": { uk: "Відділення не знайдено", ru: "Отделение не найдено" },
  ...
  "err.slotNotFound": { uk: "Час прийому не знайдено", ru: "Время приёма не найдено" },
  "err.slotClosed": { uk: "Цей час закритий для запису", ru: "Это время закрыто для записи" },
  "err.slotInPast": {
    uk: "Записатися на час, який уже минув, не можна",
  ...
  "err.slotForRepeatOnly": {
    uk: "Цей час — для повторного прийому",
    ru: "Это время — для повторного приёма",
  },
  "err.slotForPrimaryOnly": {
    uk: "Цей час — для першого прийому",
    ru: "Это время — для первичного приёма",
  },
  "err.notAttachedToDepartment": {
    uk: "На повторний прийом записуються ті, хто вже обслуговується у відділенні",
    ru: "На повторный приём записываются те, кто уже обслуживается в отделении",
  },
  "err.bookForSelfOnly": { uk: "Записатися можна лише самому", ru: "Записаться можно только самому" },
  "err.appointmentNotFound": { uk: "Прийом не знайдено", ru: "Приём не найден" },
  ...
  "err.appointmentClosed": {
    uk: "Прийом уже завершено або скасовано",
