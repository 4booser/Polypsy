...
export const UI = {
  ...
  "rsp.view": { uk: "Переглянути", ru: "Просмотреть", en: "View" },
  /* ── wave3:conclusion ── */
  /*
  ...
  "nav.users": { uk: "Облікові записи", ru: "Учётные записи", en: "Accounts" },
  "nav.audit": { uk: "Журнал доступу", ru: "Журнал доступа", en: "Access log" },
  /* ── audit:analytics ── */
  /*
  ...
  "dash.timeline": { uk: "Динаміка проходжень", ru: "Динамика прохождений", en: "Completion dynamics" },
  "dash.timelineHint": { uk: "Завершені проходження за днями", ru: "Завершённые прохождения по дням", en: "Finished completions by day" },
  "dash.severity": { uk: "Вираженість за всіма шкалами", ru: "Выраженность по всем шкалам", en: "Severity across all scales" },
  "dash.severityHint": { uk: "Скільки результатів потрапило до кожної категорії норм", ru: "Сколько результатов попало в каждую категорию норм", en: "How many results fell into each norm category" },
  "dash.load": { uk: "Навантаження за методиками", ru: "Нагрузка по методикам", en: "Load by instrument" },
  "dash.loadHint": { uk: "Кількість завершених проходжень", ru: "Число завершённых прохождений", en: "Number of finished completions" },
  "dash.severityTrend": { uk: "Вираженість за тижнями", ru: "Выраженность по неделям", en: "Severity by week" },
  "dash.severityTrendHint": {
    ...
    en: "Each assessment is counted once — by the most severe of its scales",
  },
  "dash.severityTrendTotal": { uk: "обстежень", ru: "обследований", en: "assessments" },
  "dash.severityTrendUnbanded": {
    uk: "Без інтерпретації, бо у шкал немає норм",
    ru: "Без интерпретации, потому что у шкал нет норм",
    en: "No interpretation because the scales have no norms",
  },
  ...
  "coh.sub": { uk: "візуальний запит без SQL: звузьте вибірку і подивіться, скільки вийде", ru: "визуальный запрос без SQL: сузьте выборку и посмотрите, сколько получится", en: "visual query without SQL: narrow the sample and see how many remain" },
  ...
  "coh.ageFrom": { uk: "Вік від", ru: "Возраст от", en: "Age from" },
  ...
  "st.surveyDraft": { uk: "чернетка", ru: "черновик", en: "draft" },
  "st.surveyPublished": { uk: "опубліковано", ru: "опубликована", en: "published" },
  "st.surveyClosed": { uk: "закрито", ru: "закрыта", en: "closed" },
  ...
  "unit.chooseHint": { uk: "Звіт будується по одному підрозділу за період", ru: "Отчёт строится по одному подразделению за период", en: "The report is built for one unit over a period" },
  ...
  "an.completedOf": { uk: "завершено", ru: "завершено", en: "completed" },
  "an.of": { uk: "з", ru: "из", en: "of" },
  "an.allHistory": { uk: "Уся історія", ru: "Вся история", en: "Full history" },
  "an.tabOverview": { uk: "Загальне", ru: "Общее", en: "General" },
  ...
  "an.completed": { uk: "Завершено", ru: "Завершено", en: "Completed" },
  ...
  "an.median": { uk: "Медіана", ru: "Медиана", en: "Median" },
  "an.dynamics": { uk: "Динаміка", ru: "Динамика", en: "Dynamics" },
  "an.dropOff": { uk: "Де губляться респонденти", ru: "Где теряются респонденты", en: "Where respondents drop off" },
  "an.dropOffHint": { uk: "Скільки людей дійшло до кожного питання", ru: "Сколько человек дошло до каждого вопроса", en: "How many people reached each question" },
  "an.exports": { uk: "Вивантаження та друк", ru: "Выгрузки и печать", en: "Exports and printing" },
  "an.exportsHint": {
  ...
  "an.collapse": { uk: "Згорнути", ru: "Свернуть", en: "Collapse" },
  ...
  "an.question": { uk: "Питання", ru: "Вопрос", en: "Question" },
  "an.answers": { uk: "Відповідей", ru: "Ответов", en: "Answers" },
  ...
  "an.changedShare": { uk: "Змінювали", ru: "Меняли", en: "Changed answer" },
  "an.freeText": { uk: "Вільні відповіді", ru: "Свободные ответы", en: "Free-text answers" },
  "an.alpha": { uk: "Альфа Кронбаха", ru: "Альфа Кронбаха", en: "Cronbach's alpha" },
  ...
  "an.responsesHint": {
    ...
    en: "Each row is a separate assessment; the conclusion opens in a new tab",
  },
  "an.versionOfSurvey": { uk: "Версія методики", ru: "Версия методики", en: "Instrument version" },
  "an.versionHint": {
  ...
  "chart.results": { uk: "результатів", ru: "результатов", en: "results" },
  "chart.onAverage": { uk: "у середньому", ru: "в среднем", en: "on average" },
  ...
  "an.periodEnd": { uk: "Кінець періоду", ru: "Конец периода", en: "End of period" },
  ...
  "an.optionSpread": { uk: "Розподіл виборів", ru: "Распределение выборов", en: "Choice distribution" },
  "an.optionSpreadHint": { uk: "Частка респондентів за кожним варіантом", ru: "Доля респондентов по каждому варианту", en: "Share of respondents for each option" },
  "an.doubts": { uk: "Сумніви під час відповіді", ru: "Сомнения при ответе", en: "Hesitation while answering" },
  "an.doubtsHint": { uk: "Частка респондентів, які змінювали відповідь", ru: "Доля респондентов, менявших ответ", en: "Share of respondents who changed their answer" },
  "an.firstChoice": { uk: "Час до першого вибору", ru: "Время до первого выбора", en: "Time to first choice" },
  "an.firstChoiceHint": { uk: "Скільки думали, перш ніж відповісти", ru: "Сколько думали, прежде чем ответить", en: "How long people thought before answering" },
  "an.perQuestion": { uk: "Докладно за питаннями", ru: "Подробно по вопросам", en: "Details by question" },
  "an.perQuestionHint": { uk: "Повна таблиця метрик — сортуйте очима, усе в одному місці", ru: "Полная таблица метрик — сортируйте глазами, всё в одном месте", en: "Full metrics table — scan it by eye, everything in one place" },
  "an.type": { uk: "Тип", ru: "Тип", en: "Type" },
  "an.shown": { uk: "Показано", ru: "Показан", en: "Shown" },
  "an.skipped": { uk: "Пропуск", ru: "Пропуск", en: "Skipped" },
  "an.avgTime": { uk: "Сер. час", ru: "Ср. время", en: "Avg. time" },
  "an.spread": { uk: "Розкид", ru: "Разброс", en: "Spread" },
  "an.toChoice": { uk: "До вибору", ru: "До выбора", en: "To choice" },
  "an.edits": { uk: "Правок", ru: "Правок", en: "Edits" },
  "an.subscales": { uk: "Порівняння субшкал", ru: "Сравнение субшкал", en: "Subscale comparison" },
  "an.subscalesHint": { uk: "Розкид балів за кожною шкалою", ru: "Разброс баллов по каждой шкале", en: "Score spread for each scale" },
  "an.results": { uk: "результатів", ru: "результатов", en: "results" },
  "an.reliabilityGood": { uk: "добра", ru: "хорошая", en: "good" },
  "an.reliabilityOk": { uk: "прийнятна", ru: "приемлемая", en: "acceptable" },
  "an.reliabilityLow": { uk: "низька", ru: "низкая", en: "low" },
  ...
  "an.timeVsFast": { uk: "Час проти частки швидких відповідей", ru: "Время против доли быстрых ответов", en: "Time vs. share of fast answers" },
  "an.timeVsFastHint": { uk: "Точки біля лівого краю пройшли методику швидше, ніж її можна прочитати", ru: "Точки у левого края прошли методику быстрее, чем её можно прочесть", en: "Points near the left edge completed the instrument faster than it can be read" },
  "an.durationAxis": { uk: "час проходження, с", ru: "время прохождения, с", en: "completion time, s" },
  ...
  "an.status": { uk: "Статус", ru: "Статус", en: "Status" },
  ...
  "adm.accountsTitle": { uk: "Облікові записи", ru: "Учётные записи", en: "Accounts" },
  ...
  "cl.status": { uk: "Статус", ru: "Статус", en: "Status" },
  "cl.visibility": { uk: "Видимість", ru: "Видимость", en: "Visibility" },
  "cl.questions": { uk: "Питань", ru: "Вопросов", en: "Questions" },
  "cl.responses": { uk: "Проходжень", ru: "Прохождений", en: "Completions" },
  "cl.byGrant": { uk: "за призначенням", ru: "по назначению", en: "by assignment" },
  "sch.from": { uk: "з", ru: "с", en: "from" },
  ...
  "dash.allSurveys": { uk: "Усі методики", ru: "Все методики", en: "All instruments" },
  "dash.allSurveysHint": { uk: "Відкрийте методику, щоб побачити докладні зрізи", ru: "Откройте методику, чтобы увидеть подробные срезы", en: "Open an instrument to see detailed breakdowns" },
  "dash.survey": { uk: "Методика", ru: "Методика", en: "Instrument" },
  "dash.public": { uk: "загальна", ru: "общая", en: "public" },
  ...
  "back.toDashboard": { uk: "← Зведення", ru: "← Сводка", en: "← Overview" },
  ...
  "aud.patient": { uk: "Пацієнт", ru: "Пациент", en: "Patient" },
  ...
  "an.averageWord": { uk: "середнє", ru: "среднее", en: "mean" },
  "an.codebookExported": { uk: "Codebook вивантажено", ru: "Codebook выгружен", en: "Codebook exported" },
  "an.consistency": { uk: "узгодженість", ru: "согласованность", en: "consistency" },
  "an.dropOffPartial": {
    ...
    en: "Showing the first, the last and the steps with drop-off — total questions:",
  },
  "an.exportsNote": {
  ...
  "an.fastPercentLabel": { uk: "% швидких", ru: "% быстрых", en: "% fast" },
  "an.flagHint": {
  ...
  "an.flaggedCount": { uk: "Позначено", ru: "Помечено", en: "Flagged" },
  "an.inProgressNow": { uk: "Зараз проходять:", ru: "Сейчас проходят:", en: "In progress now:" },
  "an.itemsDat": { uk: "пунктами", ru: "пунктам", en: "items" },
  ...
  "an.perItems": { uk: "за", ru: "по", en: "across" },
  "an.questionAbbr": { uk: "П", ru: "В", en: "Q" },
  "an.rangeWord": { uk: "діапазон", ru: "диапазон", en: "range" },
  "an.secAbbr": { uk: "с", ru: "с", en: "s" },
  "an.secPerQuestion": { uk: "с на питання.", ru: "с на вопрос.", en: "s per question." },
  "an.thresholdLabel": { uk: "Поріг «занадто швидко» —", ru: "Порог «слишком быстро» —", en: "“Too fast” threshold —" },
